...
import com.sbootvue.common.annotion.Excels;
import com.sbootvue.common.annotion.Excel.ColumnType;
import com.sbootvue.common.annotion.Excel.Type;
...
public class SysUser extends BaseEntity {
	...
	/** 用户ID */
	@Excel(name = "用户编号", cellType = ColumnType.NUMERIC, prompt = "当用户数据导入，如要更新已存在的用户，必填项。")
	...
	/** 最后登陆时间 */
	@Excel(name = "最后登陆时间", width = 30, type = Type.EXPORT)
