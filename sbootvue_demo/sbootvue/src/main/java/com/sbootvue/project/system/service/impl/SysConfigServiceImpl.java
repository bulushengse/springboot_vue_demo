...
import com.sbootvue.project.system.domain.SysConfig;
import com.sbootvue.project.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService {
	...
	public String checkConfigKeyUnique(SysConfig config) {
		...
		if (StringUtils.isNotNull(info) && !configId.equals(info.getConfigId())) {
